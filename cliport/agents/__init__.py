...
from cliport.agents.transporter_lang_goal import cjjagent, cjjagent_attn, cjjagent_two_stream
...
names = {
         ...
         'ours': cjjagent,
         'ours_trans_two_stream': cjjagent_two_stream,
         'ours_attn': cjjagent_attn,
